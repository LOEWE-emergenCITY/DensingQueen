...
{
    public class TS2FollowObject : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (IsInSwitchMode)
            {
                ...
                var position = originTransform.position - new Vector3(0, 0.1f,0); // without the new vector, the lineRenderer is exactly in our eyes and it is not shown
